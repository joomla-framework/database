...
[
    ...
    pipeline_mysql('8.1', 'mysql', '5.7', '--prefer-stable --prefer-lowest'),
    ...
    pipeline_mysql('8.1', 'mysqli', '5.7', '--prefer-stable --prefer-lowest'),
    ...
    pipeline_mariadb('8.1', 'mariadb', '10.2', '--prefer-stable --prefer-lowest'),
