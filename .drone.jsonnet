...
[
    ...
    pipeline_sqlite('8.4', 'sqlite', '--prefer-stable'),
    ...
    pipeline_mysql('8.4', 'mysql', '5.7', '--prefer-stable'),
    ...
    pipeline_mysql('8.4', 'mysql', '8.0', '--prefer-stable'),
    ...
    pipeline_mysql('8.4', 'mysqli', '5.7', '--prefer-stable'),
    ...
    pipeline_mysql('8.4', 'mysqli', '8.0', '--prefer-stable'),
    ...
    pipeline_mariadb('8.4', 'mariadb', '10.2', '--prefer-stable'),
    ...
    pipeline_postgres('8.4', 'pgsql', '10', '--prefer-stable'),
    ...
    pipeline_postgres('8.4', 'pgsql', '11', '--prefer-stable'),
    ...
    pipeline_sqlsrv('8.4', 'sqlsrv', '2017-latest', '--prefer-stable'),
]
