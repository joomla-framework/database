...
/**
 * Class to expose protected properties and methods in \Joomla\Database\Postgresql\PostgresqlImporter for testing purposes
 *
 * @since  1.0
 */
class PostgresqlImporterInspector extends PostgresqlImporter
{
	/**
