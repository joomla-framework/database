...
/**
 * Class to expose protected properties and methods in \Joomla\Database\Mysql\MysqlImporter for testing purposes.
 *
 * @since  1.0
 */
class MysqlImporterInspector extends MysqlImporter
{
	/**
