...
/**
 * Class to expose protected properties and methods in \Joomla\Database\Mysql\MysqlExporter for testing purposes.
 *
 * @since  1.0
 */
class MysqlExporterInspector extends MysqlExporter
{
	/**
