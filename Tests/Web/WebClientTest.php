...
class WebClientTest extends TestCase
{
	...
	public static function getUserAgentData()
	{
		...
		return array(
			...
			array(WebClient::WINDOWS, false, WebClient::EDGE, WebClient::EDGE,
			...
			array(WebClient::WINDOWS, false, WebClient::BLINK, WebClient::CHROME, '54.0.2840.71',
			...
			array(WebClient::WINDOWS, false, WebClient::EDG, WebClient::EDG, '75.0.107.0',
